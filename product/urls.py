...
from product.views import category, product_special, product_type, product, special_value, images
...
router.register(r'images', images.ProductImageViewSet, basename='images')
