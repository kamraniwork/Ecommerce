# Generated by Django 2.2.5 on 2022-06-16 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.ProductSpecification')),
            ],
            options={
